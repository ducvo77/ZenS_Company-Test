...
export default function Footer() {
  return (
    <div className="border-t border-gray-300 xl:px-[340px] lg:px-52 md:px-32 sm:px-24 px-6 xl:py-10 md:py-6 py-4 flex flex-col items-center xl:gap-6 md:gap-4 gap-2">
      <p className="text-center text-gray text-[#999999] text-xs !leading-5">
      ...
      <Link href={'/'} className="lg:text-sm text-xs text-[#696969]">
        Copyright 2021 HLS
      </Link>
    </div>
  )
